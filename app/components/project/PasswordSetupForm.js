    ...
    <FormControl>
      ...
      onClick={handlePasswordSetup}>
        Join ZenTasktic
          ...
          <Text fontSize="xs" color="gray.100" mt={2}>
            * This password is your only entry point to the dapp. It is not saved anywhere, so it cannnot be recovered, in case you lose it. Make sure you store this securely.
          </Text>
    </FormControl>
  );
}
